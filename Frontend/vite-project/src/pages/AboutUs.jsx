  ...
  return (
    <div className="min-h-screen bg-black text-white py-10 w-full">
      ...
      <div className="w-full px-4 md:px-10 lg:px-20">
        <div className="ml-[35rem] mr-[35rem] grid gap-12 grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {teamMembers.map((member, index) => (
            <ProfileCard
              ...
              enableTilt={true}
               onContactClick={() =>
    window.open("https://wa.me/+916203329104", "_blank")  
  }
            />
          ))}
        </div>
